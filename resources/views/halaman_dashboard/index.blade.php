    ...
    <aside class="sidebar-nav-wrapper">
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="{{ asset('halaman_dashboard/signin.html') }}"> Sign In </a>
              </li>
              <li>
                <a href="{{ asset('halaman_dashboard/signup.html') }}"> Sign Up </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="{{ asset('halaman_dashboard/alerts.html') }}"> Alerts </a>
              </li>
              <li>
                <a href="{{ asset('halaman_dashboard/buttons.html') }}"> Buttons </a>
              </li>
              <li>
                <a href="{{ asset('halaman_dashboard/cards.html') }}"> Cards </a>
              </li>
              <li>
                <a href="{{ asset('halaman_dashboard/typography.html') }}"> Typography </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_55" class="collapse dropdown-nav">
              <li>
                <a href="{{ asset('halaman_dashboard/icons.html') }}"> LineIcons </a>
              </li>
              <li>
                <a href="{{ asset('halaman_dashboard/mdi-icons.html') }}"> MDI Icons </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_5" class="collapse dropdown-nav">
              <li>
                <a href="{{ asset('halaman_dashboard/form-elements.html') }}"> From Elements </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a href="{{ asset('halaman_dashboard/tables.html') }}">
              <span class="icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <li class="nav-item">
            <a href="{{ asset('halaman_dashboard/notification.html') }}">
              <span class="icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
      ...
      <div class="promo-box">
        <div class="promo-icon">
          <img class="mx-auto" src="{{ asset('halaman_dashboard/./assets/images/logo/logo-icon-big.svg') }}" alt="Logo">
        </div>
      </div>
    </aside>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="{{ asset('halaman_dashboard/assets/images/profile/profile-image.png') }}" alt="" />
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="{{ asset('halaman_dashboard/assets/images/profile/profile-image.png') }}" alt="image">
                        </div>
                        <div class="content">
